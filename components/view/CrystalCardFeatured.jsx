...
const CrystalCardFeatured = ({ data }) => {
  ...
  return (
    <article className="w-full">
      <Link href={`/crystal/${crystalId}`} className="group block w-full">
        <div className="relative overflow-hidden rounded-xl bg-white/5 transition duration-200 group-hover:border-white/20">
          <div className="relative aspect-[4/3] w-full overflow-hidden bg-white/5">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/35 to-transparent px-4 py-4">
              <h3 className="text-center text-xl font-bold tracking-wide text-white sm:text-2xl">
                {name}
              </h3>
            </div>
          </div>
